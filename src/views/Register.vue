        ...
        <div v-if="state == first" class="items-stretch">
            ...
            <div class="text-left mb-5 ">
                ...
                <input class="w-full border-2 border-strong-gray rounded-md py-2 px-3" type="text" id="name"
                    placeholder="Ketik nama anda" v-model="name" required />
            </div>
            ...
            <div class="text-left mb-5 ">
                ...
                <input class="w-full border-2 border-strong-gray rounded-md py-2 px-3" type="email" id="email"
            ...
            <div class="text-left mb-5 ">
                ...
                <input class="w-full border-2 border-strong-gray rounded-md py-2 px-3" type="phone" id="phone"
                    placeholder="08xxxxxxxxxxxxx" v-model="phone" required />
            </div>
            ...
            <div class="text-left mb-5 ">
                ...
                <input class="w-full border-2 border-strong-gray rounded-md py-2 px-3" type="number" id="nik"
                    placeholder="Ketik NIK anda" v-model="nik" required />
            </div>
            ...
            <div class="text-left mb-5 ">
                ...
                <input ref="file" class="w-full border-2 border-strong-gray rounded-md py-2 px-3" type="file" id="ktp"
                    placeholder="Ketik ktp anda" required @change="selectImage()" />
            </div>

            <!-- FARM GROUP -->
            <div v-if="role == 'farmer'" class="text-left mb-5 ">
                <div class="mb-2 ">
                    <label for="farm-group">Kelompok Tani</label>
                </div>
